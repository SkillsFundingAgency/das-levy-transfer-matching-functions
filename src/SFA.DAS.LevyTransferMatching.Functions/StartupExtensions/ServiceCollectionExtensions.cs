...
public static class ServiceCollectionExtensions
{
    ...
    // public static IServiceCollection ConfigureNServiceBus(this IServiceCollection services, ILogger logger, Action<NServiceBusOptions> OnConfigureOptions = null)
    // {
